...
class SelfAttention(nn.Module):
	...
	def forward(self, sequence, sequence_mask):
		...
		sequence_sequence_selfattn = utils.mask_sequence(sequence_sequence_selfattn, sequence_mask)
		if not self.training: sequence_selfattn_weights = utils.mask_sequence(sequence_selfattn_weights, sequence_mask)
